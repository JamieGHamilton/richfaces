...
import org.richfaces.test.faces.staging.HttpConnection;
import org.richfaces.test.faces.staging.HttpMethod;
...
public class FacesEnvironment {
    ...
    public FacesEnvironment(ApplicationServer applicationServer) {
        ...
        facesServer.addResource("/test.xhtml", "org/richfaces/convert/test.xhtml");
        facesServer.addResource("/WEB-INF/beans.xml", "beans-default.xml");
    }
    ...
    public FacesEnvironment withRichFaces() {
        ...
        try {
            ...
            webXmlDefault = "org/richfaces/test/faces/ajax-web.xml";
            return this;
     ...
     * @param path
     * @param resource
     * @see org.richfaces.test.faces.staging.StagingServer#addResource(java.lang.String, java.net.URL)
     */
     ...
     * @param name
     * @param value
     * @see org.richfaces.test.faces.staging.StagingServer#addInitParameter(java.lang.String, java.lang.String)
     */
     ...
     * @param path
     * @param resource
     * @see org.richfaces.test.faces.staging.StagingServer#addResource(java.lang.String, java.lang.String)
     */
    ...
    protected void setupFacesListener() {
        facesServer.addWebListener(new org.jboss.weld.environment.servlet.Listener());
    ...
    public static void clearServiceLoaders()
    {
        ServiceLoader<CDIProvider> providerLoader = loadService(CDIProvider.class, CDI.class.getClassLoader());
        providerLoader.reload();
        ClearCDI.clear();
    }
    
    private static class ClearCDI extends SimpleCDI
    {
        private static void clear()
        {
            CDI.discoveredProviders = null;
            CDI.configuredProvider = null;
            try
            {
