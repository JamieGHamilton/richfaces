...
public class TreeBuilderImpl<C extends UIComponent> implements TreeBuilder<C> {
     ...
     * (non-Javadoc)
     * 
     * @see org.richfaces.test.faces.mock.component.TreeBuilder#setId(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.richfaces.test.faces.mock.component.TreeBuilder#replay()
     */
    public void replay() {
     ...
     * (non-Javadoc)
     * 
     * @see org.richfaces.test.faces.mock.component.TreeBuilder#verify()
     */
    public void verify() {
        visitTree(new TreeVisitor() {
            public void visit(TreeBuilder<?> toVisit) {
     ...
     * (non-Javadoc)
     * 
     * @see org.richfaces.test.faces.mock.component.TreeBuilder#getComponent()
     */
