...
import org.richfaces.test.faces.FilterHolder;
import org.richfaces.test.faces.ServletHolder;
...
public class StagingServer extends ApplicationServer {
	...
	private final List<ServletContainerInitializer> containerInitializers = new ArrayList<>();
	...
	private class LocalContext extends StagingServletContext {
		 ...
		 * 
		 * @see
		 * org.richfaces.test.faces.staging.StagingServletContext#valueBound(javax
		 ...
		 * 
		 * @see
		 * org.richfaces.test.faces.staging.StagingServletContext#valueReplaced(javax
		 * .servlet.ServletContextAttributeEvent)
		 */
		@Override
		 ...
		 * 
		 * @see
		 * org.richfaces.test.faces.staging.StagingServletContext#valueUnbound(javax
		 * .servlet.ServletContextAttributeEvent)
		 */
		@Override
		 ...
		 * 
		 * @see
		 * org.richfaces.test.faces.staging.StagingServletContext#getServerResource
		 * (java.lang.String)
		 */
		@Override
		protected ServerResource getServerResource(String path) {
		    if(path.equals("/WEB-INF/classes")) {
		        return new ClasspathServerResource("..");
		    }
	...
	private class ServerHttpSession extends StagingHttpSession {
		 ...
		 * 
		 * @see
		 * org.richfaces.test.faces.staging.StagingHttpSession#valueBound(jakarta.servlet
		 ...
		 * 
		 * @see
		 * org.richfaces.test.faces.staging.StagingHttpSession#valueUnbound(jakarta.
		 ...
		 * 
		 * @see
		 * org.richfaces.test.faces.staging.StagingHttpSession#valueReplaced(javax
		 * .servlet.http.HttpSessionBindingEvent)
		 */
		@Override
	...
	@Override
    public void addInitListener(ServletContainerInitializer listener) {
	    containerInitializers.add(listener);        
    }
	...
	private void readDefaultMimeTypes() {
	    InputStream is = null;
	    try {
	        is = Thread.currentThread().getContextClassLoader().getResourceAsStream("org/richfaces/test/faces/staging/mime.properties");
    ...
    public void init() {
        ...
        containerInitializers.forEach( init -> {
            try {
                init.onStartup(null, context);
            }
