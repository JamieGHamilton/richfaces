 ...
 */
package org.richfaces.test.faces.mockito.factory;
...
public class FactoryMockImpl<T> implements FactoryMock<T> {
     ...
     * (non-Javadoc)
     * 
     * @see org.richfaces.test.faces.mockito.factory.FactoryMock#getMockClass()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.richfaces.test.faces.mockito.factory.FactoryMock#getMockName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.richfaces.test.faces.mockito.factory.FactoryMock#createNewMockInstance()
     */
    @SuppressWarnings("unchecked")
