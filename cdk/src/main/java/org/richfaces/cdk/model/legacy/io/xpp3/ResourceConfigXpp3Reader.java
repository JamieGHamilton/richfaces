...
public class ResourceConfigXpp3Reader
{
     ...
     * @return Renderer
     */
    private Renderer parseRenderer( String tagName, XmlPullParser parser, boolean strict )
        throws IOException, XmlPullParserException
    {
        Renderer renderer = new Renderer();
        if ( parser.getAttributeValue( "", "class" ) != null  )
        {
            renderer.setClassName( getTrimmedValue( parser.getAttributeValue( "", "class" ) ) );
        }
        ...
        return renderer;
    } //-- Renderer parseRenderer( String, XmlPullParser, boolean )
        ...
        throws IOException, XmlPullParserException
    {
        ...
        if ( parser.getAttributeValue( "", "class" ) != null  )
        {
            resource.setClassName( getTrimmedValue( parser.getAttributeValue( "", "class" ) ) );
        }
        java.util.Set parsed = new java.util.HashSet();
        while ( parser.nextTag() == XmlPullParser.START_TAG )
        {
            ...
            {
                resource.setName( getTrimmedValue( parser.nextText() ) );
            }
            else if ( checkFieldWithDuplicate( parser, "path", null, parsed ) )
            {
                resource.setPath( getTrimmedValue( parser.nextText() ) );
            }
            else if ( checkFieldWithDuplicate( parser, "renderer", null, parsed ) )
            {
                resource.setRenderer( parseRenderer( "renderer", parser, strict ) );
            }
            else
            {
                if ( strict )
     ...
     */
    private ResourceConfig parseResourceConfig( String tagName, XmlPullParser parser, boolean strict )
        throws IOException, XmlPullParserException
    {
        ...
        resourceConfig.setModelEncoding( parser.getInputEncoding() );
        while ( eventType != XmlPullParser.END_DOCUMENT )
        {
            if ( eventType == XmlPullParser.START_TAG )
            {
                ...
                {
                    java.util.List resources = resourceConfig.getResources();
                    if ( resources == null )
                    {
        ...
        return resourceConfig;
    } //-- ResourceConfig parseResourceConfig( String, XmlPullParser, boolean )
     ...
     * @return ResourceConfig
     */
    public ResourceConfig read( Reader reader, boolean strict )
        throws IOException, XmlPullParserException
    {
        ...
        parser.next();
        return parseResourceConfig( "resource-config", parser, strict );
    } //-- ResourceConfig read( Reader, boolean )
     ...
     * @return ResourceConfig
     */
    public ResourceConfig read( InputStream in, boolean strict )
        throws IOException, XmlPullParserException
    {
        Reader reader = ReaderFactory.newXmlReader( in );

        return read( reader, strict );
    } //-- ResourceConfig read( InputStream, boolean )
        ...
        throws IOException, XmlPullParserException
    {
        ...
        return read( reader );
    } //-- ResourceConfig read( InputStream )
