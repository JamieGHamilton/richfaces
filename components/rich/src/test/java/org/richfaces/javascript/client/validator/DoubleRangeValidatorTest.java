...
public class DoubleRangeValidatorTest extends ValidatorTestBase {
    ...
    public static List<RunParameters[]> parameters() {
        return options(pass(0L), 
                pass(3L), 
                pass(Double.MAX_VALUE), 
                pass(0.0D, MINIMUM, 2.0D, IGNORE_MESSAGE, true),
                pass(2.0D, MINIMUM, 2.0D), 
                pass(3.0D, MINIMUM, 2.0D), 
                pass(-3.0D, MINIMUM, 2.0D, IGNORE_MESSAGE, true),
                pass(0.0D, MAXIMUM, 2.0D), 
                pass(2.0D, MAXIMUM, 2.0D), 
                pass(3.0D, MAXIMUM, 2.0D, IGNORE_MESSAGE, true),
                pass(-3.0D, MAXIMUM, 2.0D), 
                pass(0.0D, MINIMUM, 3.0D, MAXIMUM, 5.0D, IGNORE_MESSAGE, true),
                pass(3.0D, MINIMUM, 3.0D, MAXIMUM, 5.0D), 
                pass(4.0D, MINIMUM, 3.0D, MAXIMUM, 5.0D),
